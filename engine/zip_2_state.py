...
Start Date:  062219
Updated:  100921 (Fixed NYC Boroughs)
...
zip_code_list = [['Alaska', 'AK', 99501, 99950],
    ...
    ['Long Island', 'NY', 501, 6390],
    ['Manhattan', 'NY', 10001, 10286],
    ['Staten Island', 'NY', 10301, 10314],
    ['Bronx', 'NY', 10451, 10475],
    ['Westchester', 'NY', 10501, 10805],
    ['New York', 'NY', 10901, 11003],
    ['Queens', 'NY', 11004, 11005],
    ['New York', 'NY', 11006, 11096],
    ['Queens', 'NY', 11101, 11120],
    ['Brooklyn', 'NY', 11201, 11256],
    ['Queens', 'NY', 11351, 11499],
    ['Long Island', 'NY', 11501, 11980],
    ['New York', 'NY', 12007, 14905],
    ...
    ['Japan', 'JAP', 5, 5],
    ['Australia', 'AUS', 6, 6],
    ['South America', 'SOU', 7, 7],
    ['Central America', 'CEN', 8, 8],
    ['Carribean', 'CAR', 9, 9],
    ['Europe', 'EUR', 10, 10],
    ['Africa', 'AFR', 11, 11],
    ['Middle East', 'MID', 12, 12],
    ['Asia', 'ASI', 13, 13],
    ['Russia', 'RUS', 14, 14],
    ['Saudia Arabia', 'SA', 15, 15],
